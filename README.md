...
The dataset (~130 nodes) is mocked and **generated by a seeded script** — `uv run scripts/generate_b2b_vault.py` — which writes the Obsidian vault and embeds deliberate, query-able patterns: trust clusters, a fraud ring (companies sharing principals), supply chains, and trust hubs.
